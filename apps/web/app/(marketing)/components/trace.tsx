 ...
 *
 * The 1.2s pause between the hold at 2.7s and the approval at 3.9s is the
 * argument: everything before it is the agent proposing, everything after is a
 * person deciding. Everything else was tightened; that beat was not.
 */
export function TraceFragment() {
  return (
    <figure className="trace">
      <Sequence cycle={7} className="seq--onband">
        <div className="trace__card">
          ...
          <ol className="trace__steps">
            <li className="trace__step seq-step" style={at(0.2)}>
            ...
            <li className="trace__step seq-step" style={at(0.7)}>
              <span className="trace__dot" aria-hidden="true" />
            ...
            <li className="trace__step trace__step--open seq-step" style={at(1.2)}>
              <span className="trace__dot" aria-hidden="true" />
              <span className="trace__kind">tool</span>
              <span className="trace__name">create_replacement</span>
              <span className="trace__detail">write_high</span>

              <div className="trace__nested seq-step" style={at(1.5)}>
                <p className="trace__nested-head">policy · acme_damaged_order 1.0.0</p>
                <dl className="trace__facts">
                  <div className="seq-step" style={at(1.7)}>
                    <dt>daysSinceDelivery</dt>
                    <dd>3</dd>
                  </div>
                  <div className="seq-step" style={at(1.9)}>
                    <dt>amountMinor</dt>
                    <dd>899900</dd>
                  </div>
                  <div className="seq-step" style={at(2.1)}>
                    <dt>orderStatus</dt>
                    <dd>delivered</dd>
                  </div>
                  <div className="seq-step" style={at(2.3)}>
                    <dt>itemCategory</dt>
                    <dd>appliance</dd>
                  </div>
                </dl>
                <p className="trace__rule-row seq-step" style={at(2.7)}>
                  <span>high_value_needs_approval</span>
                  <span className="chip chip--amber">require_approval</span>
                </p>
              </div>

              <p className="trace__sub seq-step" style={at(3.9)}>
                <span className="trace__sub-label">approval</span>
                <span>granted · operator@acme.test</span>
              </p>
              <p className="trace__sub seq-step" style={at(4.3)}>
                <span className="trace__sub-label">executed</span>
                <span>REP-0001</span>
              </p>
            </li>

            <li className="trace__step seq-step" style={at(4.7)}>
              <span className="trace__dot" aria-hidden="true" />
            ...
            <li className="trace__step seq-step" style={at(5.4)}>
              <span className="trace__dot" aria-hidden="true" />
          ...
          <p className="trace__readback seq-step" style={at(5.1)}>
